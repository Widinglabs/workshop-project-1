---
description: Create an implementation plan through codebase analysis and research
...
**Output path**: `.claude/artifacts/plans/{feature-name}.plan.md`
...
**File**: `.claude/artifacts/plans/{feature-name}.plan.md`
...
**Next**: Run `/implement .claude/artifacts/plans/{feature-name}.plan.md`
```
