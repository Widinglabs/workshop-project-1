...
This is the second exercise for the Agentic Engineering Workshop. After experiencing your natural workflow in Exercise 1, you'll now apply the **PIV Loop** - a systematic approach to AI-assisted coding that dramatically improves output quality and gives you more control over the implementation.
