...
**ASK THE USER**: "What is the path to the plan file? (e.g., `.github/artifacts/plans/feature-name.plan.md`)"
...
**Output path**: `.github/artifacts/reports/{plan-name}-report.md`
...
### Report
`.github/artifacts/reports/{name}-report.md`
