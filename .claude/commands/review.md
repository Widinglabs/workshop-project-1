---
description: Code review - check diff, run validation, report issues
argument-hint: <file(s) | branch | "staged" | "all">
---
...
**Output path**: `.claude/artifacts/reviews/{branch-name}-review.md`
...
### Report
`.claude/artifacts/reviews/{branch-name}-review.md`
```
